...
@Service
public class LegalRepresentativeCreateBailCaseLinkPersonalisation implements LegalRepresentativeBailEmailNotificationPersonalisation {

    private final String createBailCaseLinkLegalRepresentativeTemplateId;


    public LegalRepresentativeCreateBailCaseLinkPersonalisation(
        @NotNull(message = "bailApplicationEditAfterSubmitLegalRepresentativeTemplateId cannot be null")
        @Value("${govnotify.bail.template.createBailCaseLinkLR.email}") String createBailCaseLinkLegalRepresentativeTemplateId
    ) {
        this.createBailCaseLinkLegalRepresentativeTemplateId = createBailCaseLinkLegalRepresentativeTemplateId;
    }

    @Override
    public String getTemplateId() {
        return createBailCaseLinkLegalRepresentativeTemplateId;
    }

    @Override
    public String getReferenceId(Long caseId) {
        return caseId + "_CREATE_BAIL_CASE_LINK_LEGAL_REP";
    }

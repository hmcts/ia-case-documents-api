...
@Component
public class InternalDecisionWithoutHearingGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public InternalDecisionWithoutHearingGenerator(
            @Qualifier("internalDetainedDecisionWithoutHearingNotice") DocumentCreator<AsylumCase> documentCreator,
    ...
    public boolean canHandle(
        ...
        log.info("Entering internal detained decision without hearing pre submit handler in docs api");
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        Document internalDetainedDecisionWithoutHearingNotice = documentCreator.create(caseDetails);

        documentHandler.addWithMetadataWithoutReplacingExistingDocuments(
                asylumCase,
                internalDetainedDecisionWithoutHearingNotice,

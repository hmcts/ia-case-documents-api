...
@Component
public class DetainedLegalRepRemovedIrcPrisonLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public DetainedLegalRepRemovedIrcPrisonLetterGenerator(
            @Qualifier("detainedLegalRepRemovedIrcPrisonLetterCreator") DocumentCreator<AsylumCase> documentCreator,

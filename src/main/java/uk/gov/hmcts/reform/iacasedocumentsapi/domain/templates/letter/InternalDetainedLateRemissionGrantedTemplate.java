...
@Component
public class InternalDetainedLateRemissionGrantedTemplate implements DocumentTemplate<AsylumCase> {
    ...
    public InternalDetainedLateRemissionGrantedTemplate(
            @Value("${internalDetainedLateRemissionGrantedLetter.templateName}") String templateName,

...
@Component
public class CmrReListingDetainedOtherAppellantLetterBundler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public CmrReListingDetainedOtherAppellantLetterBundler(
        @Value("${cmrReListingDetainedOtherLetterWithAttachment.fileExtension}") String fileExtension,
        @Value("${cmrReListingDetainedOtherLetterWithAttachment.fileName}") String fileName,
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        List<DocumentWithMetadata> bundleDocuments = getMaybeLetterNotificationDocuments(asylumCase, DocumentTag.INTERNAL_CMR_RE_LISTING_LETTER);

        Document cmrReListingLetterBundle = documentBundler.bundleWithoutContentsOrCoverSheets(
            bundleDocuments,

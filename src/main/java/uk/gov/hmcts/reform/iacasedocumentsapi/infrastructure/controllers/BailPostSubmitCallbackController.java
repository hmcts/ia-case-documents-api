...
@RestController
public class BailPostSubmitCallbackController extends PostSubmitCallbackController<BailCase> {

    public BailPostSubmitCallbackController(PostSubmitCallbackDispatcher<BailCase> callbackDispatcher) {

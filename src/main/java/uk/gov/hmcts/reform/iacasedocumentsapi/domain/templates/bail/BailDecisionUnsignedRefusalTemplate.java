...
@Component
public class BailDecisionUnsignedRefusalTemplate implements DocumentTemplate<BailCase> {

    private final String templateName;
    private final BailDecisionUnsignedTemplateHelper bailDecisionUnsignedTemplateHelper;

    public BailDecisionUnsignedRefusalTemplate(
        @Value("${decisionUnsignedDocument.refusal.templateName}") String templateName,

...
@Component
public class HomeOfficeNonStandardDirectionLetterTemplate implements DocumentTemplate<AsylumCase> {

    private final String templateName;
    private final CustomerServicesProvider customerServicesProvider;
    private final DirectionFinder directionFinder;

    public HomeOfficeNonStandardDirectionLetterTemplate(
        @Value("${homeOfficeNonStandardDirectionLetter.templateName}") String templateName,
    ...
    public Map<String, Object> mapFieldValues(
        ...
        fieldValues.put("directionExplanation", direction.get().getExplanation());

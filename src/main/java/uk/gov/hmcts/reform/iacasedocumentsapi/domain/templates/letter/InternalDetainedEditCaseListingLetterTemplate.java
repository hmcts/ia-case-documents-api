...
@Component
public class InternalDetainedEditCaseListingLetterTemplate implements DocumentTemplate<AsylumCase> {
    ...
    public InternalDetainedEditCaseListingLetterTemplate(
        @Value("${internalDetainedEditCaseListingLetter.templateName}") String templateName,

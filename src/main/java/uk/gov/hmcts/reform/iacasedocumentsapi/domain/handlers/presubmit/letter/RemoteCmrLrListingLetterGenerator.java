...
@Component
public class RemoteCmrLrListingLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public RemoteCmrLrListingLetterGenerator(
            @Qualifier("remoteCmrLrListingLetter") DocumentCreator<AsylumCase> documentCreator,

...
public class LegalRepresentativeRemissionDecisionPaRejectedPersonalisation implements LegalRepresentativeEmailNotificationPersonalisation {
    ...
    public LegalRepresentativeRemissionDecisionPaRejectedPersonalisation(
        @Value("${govnotify.template.remissionDecision.legalRep.pa.rejected.email}") String rejectedTemplateId,

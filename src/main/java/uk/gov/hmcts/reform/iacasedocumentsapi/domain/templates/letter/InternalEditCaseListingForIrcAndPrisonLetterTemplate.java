...
@Component
public class InternalEditCaseListingForIrcAndPrisonLetterTemplate implements DocumentTemplate<AsylumCase> {
    ...
    public InternalEditCaseListingForIrcAndPrisonLetterTemplate(
        @Value("${internalEditCaseListingForIrcAndPrisonLetter.templateName}") String templateName,

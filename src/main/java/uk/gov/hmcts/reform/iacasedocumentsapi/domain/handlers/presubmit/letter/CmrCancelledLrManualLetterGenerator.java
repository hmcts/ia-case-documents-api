...
@Component
public class CmrCancelledLrManualLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public CmrCancelledLrManualLetterGenerator(
            @Qualifier("cmrCancelledLrManualLetter") DocumentCreator<AsylumCase> documentCreator,
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        Document cmrCancelledLrManualLetter = documentCreator.create(caseDetails);

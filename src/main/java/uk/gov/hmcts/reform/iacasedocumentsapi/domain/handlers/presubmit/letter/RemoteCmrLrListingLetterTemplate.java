...
@Component
public class RemoteCmrLrListingLetterTemplate implements DocumentTemplate<AsylumCase> {
    ...
    public RemoteCmrLrListingLetterTemplate(
            @Value("${remoteCmrLrListingLetter.templateName}") String templateName,

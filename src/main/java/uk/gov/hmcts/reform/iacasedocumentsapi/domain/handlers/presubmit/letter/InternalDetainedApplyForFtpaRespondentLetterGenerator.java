...
@Component
public class InternalDetainedApplyForFtpaRespondentLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public InternalDetainedApplyForFtpaRespondentLetterGenerator(
            @Qualifier("internalApplyForFtpaRespondent") DocumentCreator<AsylumCase> documentCreator,

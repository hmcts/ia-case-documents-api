...
public class DocumentCreatorConfiguration {
    ...
    @Bean("internalDetainedCmrListing")
    public DocumentCreator<AsylumCase> getInternalDetainedCmrListingDocumentCreator(
        @Value("${internalDetainedCmrListingLetter.contentType}") String contentType,
        @Value("${internalDetainedCmrListingLetter.fileExtension}") String fileExtension,
        @Value("${internalDetainedCmrListingLetter.fileName}") String fileName,
        AsylumCaseFileNameQualifier fileNameQualifier,
        InternalDetainedCmrListingLetterTemplate documentTemplate,
        DocumentGenerator documentGenerator,
        DocumentUploader documentUploader
    ) {
        return new DocumentCreator<>(
    ...
    public DocumentCreator<AsylumCase> getInternalCmrListingAppellantLetterDocumentCreator(
        ...
        AsylumCaseFileNameQualifier fileNameQualifier,
        InternalCmrListingAppellantLetterTemplate documentTemplate,
        DocumentGenerator documentGenerator,
        DocumentUploader documentUploader
    ) {
        return new DocumentCreator<>(
    ...
    @Bean("internalDetainedLateRemissionRefusedTemplateLetter")
    public DocumentCreator<AsylumCase> getInternalDetainedLateRemissionRefusedDocumentCreator(
            @Value("${internalDetainedLateRemissionRefusedLetter.contentType}") String contentType,
            @Value("${internalDetainedLateRemissionRefusedLetter.fileExtension}") String fileExtension,
            @Value("${internalDetainedLateRemissionRefusedLetter.fileName}") String fileName,
            AsylumCaseFileNameQualifier fileNameQualifier,
            InternalDetainedLateRemissionRefusedTemplate documentTemplate,
            DocumentGenerator documentGenerator,
            DocumentUploader documentUploader
    ) {
        return new DocumentCreator<>(

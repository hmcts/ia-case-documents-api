...
@Service
public class HomeOfficeMaintainBailCaseLinksPersonalisation implements BailEmailNotificationPersonalisation {

    private final String homeOfficeMaintainCaseLinkWithLegalRepPersonalisationTemplateId;
    private final String homeOfficeMaintainCaseLinksWithoutLegalRepPersonalisationTemplateId;
    private final String bailHomeOfficeEmailAddress;


    public HomeOfficeMaintainBailCaseLinksPersonalisation(
        @NotNull(message = "homeOfficeBailApplicationEndedPersonalisationTemplateId cannot be null")
        @Value("${govnotify.bail.template.maintainBailCaseLinksHO.email}") String homeOfficeMaintainCaseLinkWithLegalRepPersonalisationTemplateId,
        @Value("${govnotify.bail.template.maintainBailCaseLinksHOWithoutLR.email}") String homeOfficeMaintainCaseLinksWithoutLegalRepPersonalisationTemplateId,
        @Value("${bailHomeOfficeEmailAddress}") String bailHomeOfficeEmailAddress
    ) {
        this.homeOfficeMaintainCaseLinkWithLegalRepPersonalisationTemplateId = homeOfficeMaintainCaseLinkWithLegalRepPersonalisationTemplateId;
        this.homeOfficeMaintainCaseLinksWithoutLegalRepPersonalisationTemplateId = homeOfficeMaintainCaseLinksWithoutLegalRepPersonalisationTemplateId;
        this.bailHomeOfficeEmailAddress = bailHomeOfficeEmailAddress;
    }

    @Override
    public String getReferenceId(Long caseId) {
        return caseId + "_MAINTAIN_BAIL_CASE_LINKS_HOME_OFFICE";
    }
    ...
    public String getTemplateId(BailCase bailCase) {
        return bailCase.read(IS_LEGALLY_REPRESENTED_FOR_FLAG, YesOrNo.class).orElse(YesOrNo.NO) == YesOrNo.YES
            ? homeOfficeMaintainCaseLinkWithLegalRepPersonalisationTemplateId : homeOfficeMaintainCaseLinksWithoutLegalRepPersonalisationTemplateId;
    }

...
@Service
public class HomeOfficeCreateBailCaseLinkPersonalisation implements BailEmailNotificationPersonalisation {

    private final String homeOfficeCreateCaseLinkWithLegalRepPersonalisationTemplateId;
    private final String homeOfficeCreateCaseLinkWithoutLegalRepPersonalisationTemplateId;
    private final String bailHomeOfficeEmailAddress;


    public HomeOfficeCreateBailCaseLinkPersonalisation(
        @NotNull(message = "homeOfficeBailApplicationEndedPersonalisationTemplateId cannot be null")
        @Value("${govnotify.bail.template.createBailCaseLinkHO.email}") String homeOfficeCreateCaseLinkWithLegalRepPersonalisationTemplateId,
        @Value("${govnotify.bail.template.createBailCaseLinkHOWithoutLR.email}") String homeOfficeCreateCaseLinkWithoutLegalRepPersonalisationTemplateId,
        @Value("${bailHomeOfficeEmailAddress}") String bailHomeOfficeEmailAddress
    ) {
        this.homeOfficeCreateCaseLinkWithLegalRepPersonalisationTemplateId = homeOfficeCreateCaseLinkWithLegalRepPersonalisationTemplateId;
        this.homeOfficeCreateCaseLinkWithoutLegalRepPersonalisationTemplateId = homeOfficeCreateCaseLinkWithoutLegalRepPersonalisationTemplateId;
        this.bailHomeOfficeEmailAddress = bailHomeOfficeEmailAddress;
    }

    @Override
    public String getReferenceId(Long caseId) {
        return caseId + "_CREATE_BAIL_CASE_LINK_HOME_OFFICE";
    }
    ...
    public String getTemplateId(BailCase bailCase) {
        return bailCase.read(IS_LEGALLY_REPRESENTED_FOR_FLAG, YesOrNo.class).orElse(YesOrNo.NO) == YesOrNo.YES
            ? homeOfficeCreateCaseLinkWithLegalRepPersonalisationTemplateId : homeOfficeCreateCaseLinkWithoutLegalRepPersonalisationTemplateId;
    }

...
@Component
public class InternalEditCaseListingLrWithAttachmentBundleHandler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public InternalEditCaseListingLrWithAttachmentBundleHandler(

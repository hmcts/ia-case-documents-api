...
public enum AsylumCaseDefinition {
    ...
    IS_DECISION_WITHOUT_HEARING(
        "isDecisionWithoutHearing", new TypeReference<YesOrNo>() {}),
    ...
    CASE_BUNDLES(
        "caseBundles", new TypeReference<List<IdValue<uk.gov.hmcts.reform.iacasedocumentsapi.domain.entities.em.Bundle>>>(){}),

...
@Component
public class RemoteCmrListingLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public RemoteCmrListingLetterGenerator(
            @Qualifier("remoteCmrListingLetter") DocumentCreator<AsylumCase> documentCreator,

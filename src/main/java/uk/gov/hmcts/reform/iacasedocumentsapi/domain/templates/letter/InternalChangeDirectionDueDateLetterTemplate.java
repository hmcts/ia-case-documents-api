...
@Component
public class InternalChangeDirectionDueDateLetterTemplate implements DocumentTemplate<AsylumCase> {

    private final String templateName;
    private final CustomerServicesProvider customerServicesProvider;

    public InternalChangeDirectionDueDateLetterTemplate(
        @Value("${internalChangeDueDateLetter.templateName}") String templateName,

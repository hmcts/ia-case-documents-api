...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.appellant.email.*;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.appellant.letter.*;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.appellant.sms.*;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.legalrepresentative.*;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.adminofficer.AdminOfficerAdjournHearingWithoutDatePersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.adminofficer.AdminOfficerAppealSubmittedPayOfflinePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.adminofficer.AdminOfficerAppealSubmittedPendingPaymentPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.adminofficer.AdminOfficerChangeToHearingRequirementsPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.adminofficer.AdminOfficerDecidedOrEndedAppealPendingPayment;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.adminofficer.AdminOfficerEditPaymentMethodPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.adminofficer.AdminOfficerFtpaDecisionAppellantPersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.applyforcosts.AddEvidenceForCostsSubmittedSubmitterPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.applyforcosts.AdditionalEvidenceSubmittedOtherPartyNotificationPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.applyforcosts.ApplyForCostsApplicantPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.applyforcosts.ApplyForCostsRespondentPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.applyforcosts.ConsiderMakingCostOrderHoPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.applyforcosts.ConsiderMakingCostOrderLegalRepPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.applyforcosts.DecideCostsHomeOfficePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.applyforcosts.DecideCostsLegalRepPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.applyforcosts.RespondToCostsApplicantPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.applyforcosts.RespondToCostsRespondentPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerAdjournHearingWithoutDatePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerAppealOutcomeHomeOfficeNotificationFailedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerAsyncStitchingHomeOfficeNotificationFailedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerChangeHearingCentrePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerClarifyingQuestionsAnswersSubmittedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerCmaRequirementsSubmittedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerEditListingPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerFtpaDecisionHomeOfficeNotificationFailedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerFtpaDecisionPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerFtpaSubmittedHomeOfficeNotificationFailedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerHearingBundleFailedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerHomeOfficeResponseUploadedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerListCasePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerListCmaPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerMakeAnApplicationPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerManageFeeUpdatePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerPendingPaymentPaidPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerReasonForAppealSubmittedPersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerRemoveRepresentationPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerRequestHearingRequirementsPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerRespondentEvidenceSubmittedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerSubmitAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerSubmitCasePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerSubmittedHearingRequirementsPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerUploadAddendumEvidencePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.CaseOfficerUploadAdditionalEvidencePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.caseofficer.editdocument.CaseOfficerEditDocumentsPersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamAppealDecidedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamAppealFeeDuePersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamAppellantFtpaDecidedByResidentJudgePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamChangeDueDatePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamChangeHearingCentrePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamChangeHoDirectionDueDatePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamDecideARespondentApplicationPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamDecideAnApplicationPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamEditAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamEditCaseListingPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamManageFeeUpdatePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamEndAppealAutomaticallyPersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamFtpaSubmittedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamHearingAdjournedWithoutDatePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamHearingBundleReadyPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamHomeOfficeUploadAdditionalAddendumEvidencePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamInternalNonStandardDirectionToRespondentPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamLegalOfficerUploadAddendumEvidence;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamListCasePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamMaintainCaseLinkAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamMaintainCaseUnlinkAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamMarkAppealAsAdaPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamMarkAsPaidPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamNonStandardDirectionPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamRecordOutOfTimeDecisionCanProceedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamReinstateAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamRequestCaseBuildingPersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamRequestRespondentEvidencePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamRequestResponseAmendPersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamRespondentReviewPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamReviewHomeOfficeResponsePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamTransferOutOfAdaPersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamUploadAddendumEvidenceAdminOfficerPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamUploadAdditionalEvidencePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.detentionengagementteam.DetentionEngagementTeamUploadAppealResponsePersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeAdaSuitabilityPersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeAppealExitedOnlinePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeAppealOutcomePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeAppealSubmittedPayOfflinePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeAppealSubmittedPendingPaymentPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeCaseLinkPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeCaseUnlinkPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeDecideAnApplicationPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeDecisionWithoutHearingPersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeEndAppealAutomaticallyPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeEndAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeFtpaApplicationDecidedRule31Rule32Personalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeFtpaApplicationDecisionAppellantPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeFtpaApplicationDecisionRespondentPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeGenerateHearingBundlePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeHearingBundleReadyPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeListCasePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeListCmaPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeMakeAnApplicationPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeMarkAppealAsAdaPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeMarkAppealAsDetainedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeMarkAppealAsRemittedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeMarkAppealReadyForUtTransferPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeNocRequestDecisionPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeRecordApplicationPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeReinstateAppealPersonalisation;
...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeRemoveRepresentationPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeSubmitAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeTransferOutOfAdaPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeUploadAddendumEvidencePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.HomeOfficeUploadAdditionalEvidencePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.linkunlinkappeal.HomeOfficeLinkAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.homeoffice.linkunlinkappeal.HomeOfficeUnlinkAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.legalrepresentative.linkunlinkappeal.LegalRepresentativeLinkAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.legalrepresentative.linkunlinkappeal.LegalRepresentativeUnlinkAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentAdjournHearingWithoutDatePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentAppellantFtpaSubmittedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentChangeDirectionDueDatePersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentDirectionPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentEditAppealAfterSubmitPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentEvidenceDirectionPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentForceCaseProgressionPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentForceCaseToCaseUnderReviewPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentForceCaseToSubmitHearingRequirementsPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentFtpaSubmittedPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentNonStandardDirectionOfAppellantPersonalization;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentNonStandardDirectionPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentRecordAdjournmentDetailsPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentReheardUnderRule35PersonalisationEmail;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentRequestResponseAmendPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentTurnOnNotificationsPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentUpdateTribunalDecisionRule31PersonalisationEmail;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.respondent.RespondentUpdateTribunalDecisionRule32PersonalisationEmail;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.uppertribunal.UpperTribunalMarkAsReadyForUtTransferPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.service.EditListingEmailNotificationGenerator;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.service.EmailNotificationGenerator;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.service.EmailWithLinkNotificationGenerator;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.service.LetterNotificationGenerator;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.service.NotificationGenerator;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.service.NotificationIdAppender;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.service.PrecompiledLetterNotificationGenerator;
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.service.SmsNotificationGenerator;

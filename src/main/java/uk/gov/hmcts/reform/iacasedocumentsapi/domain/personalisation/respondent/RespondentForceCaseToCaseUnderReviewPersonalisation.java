...
@Service
public class RespondentForceCaseToCaseUnderReviewPersonalisation implements EmailNotificationPersonalisation {
    ...
    public RespondentForceCaseToCaseUnderReviewPersonalisation(
        @NotNull(message = "appealDocumentDeletedTemplateId cannot be null")
        @Value("${govnotify.template.forceCaseProgression.caseBuilding.to.caseUnderReview.respondent.email}")
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_RESPONDENT_FORCE_CASE_PROGRESSION_TO_UNDER_REVIEW";
    }

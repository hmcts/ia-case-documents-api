...
@Component
public class InternalDetainedAppealSubmittedOutOfTimeWithExemptionLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public InternalDetainedAppealSubmittedOutOfTimeWithExemptionLetterGenerator(
        @Qualifier("internalDetainedAppealSubmissionOutOfTimeWithExemptionLetter") DocumentCreator<AsylumCase> documentCreator,
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        Document internalDetainedAppealSubmissionOutOfTimeWithExemptionLetter = documentCreator.create(caseDetails);

        documentHandler.addWithMetadata(
            asylumCase,
            internalDetainedAppealSubmissionOutOfTimeWithExemptionLetter,

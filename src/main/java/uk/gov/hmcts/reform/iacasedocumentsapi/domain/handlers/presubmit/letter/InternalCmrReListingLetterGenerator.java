...
@Component
public class InternalCmrReListingLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        Document internalCmrReListingLetter = documentCreator.create(
            caseDetails,
            caseDetailsBefore.orElseThrow(() -> new IllegalStateException("previous case data is not present"))
        );

        documentHandler.addWithMetadataWithoutReplacingExistingDocuments(
            asylumCase,
            internalCmrReListingLetter,

...
@Service
public class AipAppellantRecordRemissionDecisionPersonalisationEmail implements EmailNotificationPersonalisation {
    ...
    public AipAppellantRecordRemissionDecisionPersonalisationEmail(
        ...
        @Value("${govnotify.template.remissionDecision.appellant.partiallyApproved.email}") String aipAppellantRemissionPartiallyApprovedTemplateId,
        @Value("${govnotify.template.remissionDecision.appellant.rejected.email}") String aipAppellantRemissionRejectedTemplateId,

...
public class PreSubmitCallbackDispatcher<T extends CaseData> {
    ...
    public PreSubmitCallbackResponse<T> handle(
        ...
        dispatchToHandlers(callbackStage, callback, sortedCallbackHandlers, callbackResponse, DispatchPriority.PAYMENTS);
        ...
        dispatchToHandlers(callbackStage, callback, sortedCallbackHandlers, callbackResponse, DispatchPriority.NOTIFICATIONS);

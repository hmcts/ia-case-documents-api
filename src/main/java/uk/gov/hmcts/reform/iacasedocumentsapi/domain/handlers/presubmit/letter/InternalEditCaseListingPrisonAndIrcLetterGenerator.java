...
@Component
public class InternalEditCaseListingPrisonAndIrcLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public InternalEditCaseListingPrisonAndIrcLetterGenerator(
        @Qualifier("internalEditCaseListingForPrisonAndIrcLetter") DocumentCreator<AsylumCase> documentCreator,

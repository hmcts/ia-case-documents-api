...
@Component
public class InternalCmrReListingAppellantLetterTemplate extends AbstractInternalCmrReListingLetterTemplate {

    public InternalCmrReListingAppellantLetterTemplate(
        @Value("${internalCmrReListingAppellantLetter.templateName}") String templateName,

...
import static uk.gov.hmcts.reform.iacasedocumentsapi.domain.entities.ApplicationApplicant.RESPONDENT;
...
@Component
public class HomeOfficeApplicationDecidedLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public HomeOfficeApplicationDecidedLetterGenerator(
        @Qualifier("homeOfficeApplicationDecidedLetter") DocumentCreator<AsylumCase> documentCreator,
    ...
    public boolean canHandle(
        ...
        return callbackStage == PreSubmitCallbackStage.ABOUT_TO_SUBMIT
               ...
               && wasApplicationSubmittedByHomeOffice(asylumCase)
    ...
    private boolean wasApplicationSubmittedByHomeOffice(AsylumCase asylumCase) {
        try {
            return getDecidedApplication(asylumCase).getApplicant().equals(RESPONDENT.getValue());

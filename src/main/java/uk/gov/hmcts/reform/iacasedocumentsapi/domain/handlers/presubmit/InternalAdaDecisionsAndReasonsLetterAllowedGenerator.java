...
@Component
public class InternalAdaDecisionsAndReasonsLetterAllowedGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> internalAdaDecisionsAndReasonsLetterAllowedCreator;
    private final DocumentHandler documentHandler;

    public InternalAdaDecisionsAndReasonsLetterAllowedGenerator(
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        Document internalAdaDecisionsAndReasonsLetterAllowed = internalAdaDecisionsAndReasonsLetterAllowedCreator.create(caseDetails);
        ...
        if (appealDecision.equals(AppealDecision.ALLOWED)) {
            documentHandler.addWithMetadata(
                asylumCase,
                internalAdaDecisionsAndReasonsLetterAllowed,

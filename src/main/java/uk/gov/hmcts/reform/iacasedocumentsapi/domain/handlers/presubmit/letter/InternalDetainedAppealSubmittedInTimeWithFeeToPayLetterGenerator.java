...
@Component
public class InternalDetainedAppealSubmittedInTimeWithFeeToPayLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public InternalDetainedAppealSubmittedInTimeWithFeeToPayLetterGenerator(
            @Qualifier("internalDetainedAppealSubmissionInTimeWithFeeToPayLetter") DocumentCreator<AsylumCase> documentCreator,

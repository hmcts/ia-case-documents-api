...
@Component
public class InternalEditCaseListingPrisonAndIrcAttachmentBundler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public InternalEditCaseListingPrisonAndIrcAttachmentBundler(
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        List<DocumentWithMetadata> bundleDocuments = getMaybeNotificationAttachmentDocuments(asylumCase, INTERNAL_EDIT_CASE_LISTING_LETTER);
        ...
        documentHandler.addWithMetadataWithoutReplacingExistingDocuments(
            ...
            INTERNAL_EDIT_CASE_LISTING_LETTER_BUNDLE
        );

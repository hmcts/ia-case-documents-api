...
@Component
public class BailDecisionUnsignedMindedRefusalCreator implements PreSubmitCallbackHandler<BailCase> {

    private final DocumentCreator<BailCase> bailDocumentCreator;
    private final BailDocumentHandler bailDocumentHandler;

    public BailDecisionUnsignedMindedRefusalCreator(
        @Qualifier("decisionUnsignedMindedRefusal") DocumentCreator<BailCase> bailDocumentCreator,

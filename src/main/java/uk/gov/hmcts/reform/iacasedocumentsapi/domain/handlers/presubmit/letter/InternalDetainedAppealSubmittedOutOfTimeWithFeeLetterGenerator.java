...
@Component
public class InternalDetainedAppealSubmittedOutOfTimeWithFeeLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public InternalDetainedAppealSubmittedOutOfTimeWithFeeLetterGenerator(
        @Qualifier("internalDetainedAppealSubmissionOutOfTimeWithFeeLetter") DocumentCreator<AsylumCase> documentCreator,
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        Document internalDetainedAppealSubmissionOutOfTimeWithFeeLetter = documentCreator.create(caseDetails);

        documentHandler.addWithMetadata(
            asylumCase,
            internalDetainedAppealSubmissionOutOfTimeWithFeeLetter,

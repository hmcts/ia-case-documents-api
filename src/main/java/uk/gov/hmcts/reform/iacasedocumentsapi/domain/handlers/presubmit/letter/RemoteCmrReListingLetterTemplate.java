...
@Component
public class RemoteCmrReListingLetterTemplate implements DocumentTemplate<AsylumCase> {
    ...
    public RemoteCmrReListingLetterTemplate(
            @Value("${remoteCmrReListingLetter.templateName}") String templateName,

...
@Component
public class RemoteCmrListingLetterTemplate implements DocumentTemplate<AsylumCase> {
    ...
    public RemoteCmrListingLetterTemplate(
            @Value("${remoteCmrListingLetter.templateName}") String templateName,

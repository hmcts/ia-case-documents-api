...
public enum DocumentTag {
    ...
    INTERNAL_CMR_RE_LISTING_LETTER("internalCmrListingLetter", CaseType.ASYLUM),
    INTERNAL_CMR_RE_LISTING_LETTER_BUNDLE("internalCmrListingLetterBundle", CaseType.ASYLUM),
    INTERNAL_CMR_RE_LISTING_LR_LETTER("internalCmrListingLrLetter", CaseType.ASYLUM),
    INTERNAL_CMR_RE_LISTING_LR_LETTER_BUNDLE("internalCmrListingLrLetterBundle", CaseType.ASYLUM),

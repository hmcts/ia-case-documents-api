...
public enum DocumentTag {
    ...
    REMOTE_CMR_LISTING_LETTER("remoteCmrListingLetter", CaseType.ASYLUM),
    REMOTE_CMR_LISTING_LETTER_BUNDLE("remoteCmrListingLetterBundle", CaseType.ASYLUM),
    REMOTE_CMR_LISTING_LR_LETTER("remoteCmrListingLrLetter", CaseType.ASYLUM),
    REMOTE_CMR_LISTING_LR_LETTER_BUNDLE("remoteCmrListingLrLetterBundle", CaseType.ASYLUM),
    ...
    REMOTE_CMR_RE_LISTING_LETTER("remoteCmrReListingLetter", CaseType.ASYLUM),
    REMOTE_CMR_RE_LISTING_LETTER_BUNDLE("remoteCmrReListingLetterBundle", CaseType.ASYLUM),
    REMOTE_CMR_RE_LISTING_LR_LETTER("remoteCmrReListingLrLetter", CaseType.ASYLUM),
    REMOTE_CMR_RE_LISTING_LR_LETTER_BUNDLE("remoteCmrReListingLrLetterBundle", CaseType.ASYLUM),

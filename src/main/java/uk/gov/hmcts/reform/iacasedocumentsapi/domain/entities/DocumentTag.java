...
public enum DocumentTag {
    ...
    INTERNAL_APPEAL_SUBMISSION_NON_ADA_IN_TIME("internalAppealSubmissionNonAdaInTime", CaseType.ASYLUM),
    ...
    INTERNAL_ADA_DECISION_AND_REASONS_LETTER("internalAdaDecisionAndReasonsLetter", CaseType.ASYLUM),

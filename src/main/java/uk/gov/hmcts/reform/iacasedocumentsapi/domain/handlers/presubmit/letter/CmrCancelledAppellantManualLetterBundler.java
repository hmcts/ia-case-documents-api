...
@Slf4j
@Component
public class CmrCancelledAppellantManualLetterBundler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public CmrCancelledAppellantManualLetterBundler(
        ...
        log.info("CmrCancelledAppellantManualLetterBundler initialised");
    }
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        Document cmrCancelledAppellantManualLetterBundle = documentBundler.bundleWithoutContentsOrCoverSheets(
                bundleDocuments,
        ...
        documentHandler.addWithMetadataWithoutReplacingExistingDocuments(
                asylumCase,
                cmrCancelledAppellantManualLetterBundle,

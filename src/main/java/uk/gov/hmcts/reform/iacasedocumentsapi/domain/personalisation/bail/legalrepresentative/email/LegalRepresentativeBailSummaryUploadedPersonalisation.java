...
@Service
public class LegalRepresentativeBailSummaryUploadedPersonalisation implements LegalRepresentativeBailEmailNotificationPersonalisation {

    private final String bailSummaryUploadedLegalRepresentativeTemplateId;
    ...
    public String getTemplateId() {
        return bailSummaryUploadedLegalRepresentativeTemplateId;
    }

    @Override
    public String getReferenceId(Long caseId) {
        return caseId + "_BAIL_SUMMARY_UPLOADED_LEGAL_REP";
    }

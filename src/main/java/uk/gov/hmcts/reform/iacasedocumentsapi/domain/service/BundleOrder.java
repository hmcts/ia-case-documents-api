    ...
    private int bundlePositionIndex(DocumentWithMetadata document) {
        ...
        return switch (document.getTag()) {
            ...
            case HOME_OFFICE_NON_STANDARD_DIRECTION_LETTER -> {
                log.warn("HOME_OFFICE_NON_STANDARD_DIRECTION_LETTER tag should not be checked for bundle ordering, document desc: {}", document.getDescription());
                yield 115;
            }
            ...
            case INTERNAL_APPEAL_DETAINED_UPDATE_TRIBUNAL_DECISION_RULE_31_IRC_PRISON_LETTER -> {
                log.warn("INTERNAL_APPEAL_DETAINED_UPDATE_TRIBUNAL_DECISION_RULE_31_IRC_PRISON_LETTER tag should not be checked for bundle ordering, document desc: {}", document.getDescription());
                yield 117;
            }
            case NONE ->  118;

...
public class BundleOrder implements Comparator<DocumentWithMetadata> {
    ...
    private int bundlePositionIndex(DocumentWithMetadata document) {
        ...
        return switch (document.getTag()) {
            ...
            case UPDATED_DECISION_AND_REASONS_COVER_LETTER -> 76;
            ...
            case REMITTAL_DECISION -> 78;
            case NOTICE_OF_ADJOURNED_HEARING -> 79;
            case APPEAL_WAS_NOT_SUBMITTED_SUPPORTING_DOCUMENT -> 80;
            ...
            case INTERNAL_DETAINED_APPEAL_ADJOURN_HEARING_WITHOUT_A_DATE_LETTER -> {

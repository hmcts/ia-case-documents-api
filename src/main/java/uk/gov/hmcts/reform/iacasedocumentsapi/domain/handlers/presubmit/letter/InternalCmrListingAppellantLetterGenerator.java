...
@Component
public class InternalCmrListingAppellantLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public InternalCmrListingAppellantLetterGenerator(
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        Document internalCmrListingLrLetter = documentCreator.create(caseDetails);

        documentHandler.addWithMetadataWithoutReplacingExistingDocuments(
            asylumCase,
            internalCmrListingLrLetter,

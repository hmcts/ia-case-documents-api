...
@Component
public class InternalUpdateTribunalDecisionR31Generator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public InternalUpdateTribunalDecisionR31Generator(
        @Qualifier("internalUpdateTribunalDecisionRule31") DocumentCreator<AsylumCase> documentCreator,
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        Document internalUpdateTribunalDecisionNotice = documentCreator.create(caseDetails);

        documentHandler.addWithMetadataWithoutReplacingExistingDocuments(
            asylumCase,
            internalUpdateTribunalDecisionNotice,

...
public class HearingNoticeTemplateConfiguration {
    ...
    public HearingNoticeTemplate getRemoteCmrHearingNoticeTemplate(
            @Value("${remoteCmrHearingNoticeDocument.templateName}") String templateName, StringProvider stringProvider) {
        return new HearingNoticeTemplate(templateName, stringProvider, customerServicesProvider);
    }

    @Bean("adaHearingNoticeTemplate")
    public HearingNoticeTemplate getAdaHearingNoticeTemplate(
    ...
    public HearingNoticeTemplate getAdaCmrHearingNoticeTemplate(

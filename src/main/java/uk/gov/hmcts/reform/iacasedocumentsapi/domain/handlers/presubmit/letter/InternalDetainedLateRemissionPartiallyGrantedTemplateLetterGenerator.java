...
@Component
public class InternalDetainedLateRemissionPartiallyGrantedTemplateLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public InternalDetainedLateRemissionPartiallyGrantedTemplateLetterGenerator(

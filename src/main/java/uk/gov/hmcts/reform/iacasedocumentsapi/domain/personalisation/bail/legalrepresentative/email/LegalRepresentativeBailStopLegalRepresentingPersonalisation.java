...
@Service
public class LegalRepresentativeBailStopLegalRepresentingPersonalisation implements LegalRepresentativeBailEmailNotificationPersonalisation {

    private final String bailStopLegalRepresentingLegalRepresentativeTemplateId;


    public LegalRepresentativeBailStopLegalRepresentingPersonalisation(
        @NotNull(message = "bailStopLegalRepresentingLegalRepresentativeTemplateId cannot be null")
        @Value("${govnotify.bail.template.stopLegalRepresenting.legalRep}") String bailStopLegalRepresentingLegalRepresentativeTemplateId
    ) {
        this.bailStopLegalRepresentingLegalRepresentativeTemplateId = bailStopLegalRepresentingLegalRepresentativeTemplateId;
    }

    @Override
    public String getTemplateId() {
        return bailStopLegalRepresentingLegalRepresentativeTemplateId;
    }

    @Override
    public String getReferenceId(Long caseId) {
        return caseId + "_BAIL_STOP_LEGAL_REPRESENTING_LEGAL_REP";
    }

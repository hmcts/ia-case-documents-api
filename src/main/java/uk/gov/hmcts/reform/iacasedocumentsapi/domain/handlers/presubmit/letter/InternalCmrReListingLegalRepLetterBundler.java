...
@Component
public class InternalCmrReListingLegalRepLetterBundler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public InternalCmrReListingLegalRepLetterBundler(
        ...
        @Value("${internalCmrReListingLrLetterWithAttachment.fileExtension}") String lrFileExtension,
        @Value("${internalCmrReListingLrLetterWithAttachment.fileName}") String lrFileName,
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        List<DocumentWithMetadata> bundleDocumentsLR = getMaybeLetterNotificationDocuments(asylumCase, DocumentTag.INTERNAL_CMR_RE_LISTING_LR_LETTER);

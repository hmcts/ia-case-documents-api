...
@Service
public class AppellantReviewTimeExtensionGrantedPersonalisationSms implements SmsNotificationPersonalisation {

    private final String reviewTimeExtensionGrantedAppellantSmsTemplateId;
    private final String iaAipFrontendUrl;
    private final RecipientsFinder recipientsFinder;
    private final TimeExtensionFinder timeExtensionFinder;

    public AppellantReviewTimeExtensionGrantedPersonalisationSms(
        @Value("${govnotify.template.reviewTimeExtensionGranted.appellant.sms}") String reviewTimeExtensionGrantedAppellantSmsTemplateId,
        @Value("${iaAipFrontendUrl}") String iaAipFrontendUrl,
        RecipientsFinder recipientsFinder,
        TimeExtensionFinder timeExtensionFinder
    ) {
        this.reviewTimeExtensionGrantedAppellantSmsTemplateId = reviewTimeExtensionGrantedAppellantSmsTemplateId;
    ...
    public String getTemplateId() {
        return reviewTimeExtensionGrantedAppellantSmsTemplateId;
    }
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_REVIEW_TIME_EXTENSION_GRANTED_APPELLANT_AIP_SMS";
    }

...
@Component
public class InternalDetainedAppealSubmittedOutOfTimeWithRemissionGrantedIrcPrisonLetterGenerator implements PreSubmitCallbackHandler<AsylumCase> {

    private final DocumentCreator<AsylumCase> documentCreator;
    private final DocumentHandler documentHandler;

    public InternalDetainedAppealSubmittedOutOfTimeWithRemissionGrantedIrcPrisonLetterGenerator(
            @Qualifier("internalDetainedOutOfTimeRemissionGrantedIrcPrisonLetterCreator") DocumentCreator<AsylumCase> documentCreator,

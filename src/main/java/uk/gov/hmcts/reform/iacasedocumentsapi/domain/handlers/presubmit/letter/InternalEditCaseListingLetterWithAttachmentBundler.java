...
@Component
public class InternalEditCaseListingLetterWithAttachmentBundler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public InternalEditCaseListingLetterWithAttachmentBundler(

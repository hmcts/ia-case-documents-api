...
import static uk.gov.hmcts.reform.iacasedocumentsapi.iacasepaymentsapi.domain.entities.AsylumCaseDefinition.FEE_CODE;
import static uk.gov.hmcts.reform.iacasedocumentsapi.iacasepaymentsapi.domain.entities.AsylumCaseDefinition.FEE_DESCRIPTION;
...
public class FeesHelper {
    ...
    public static Fee findFeeByHearingType(FeeService feeService, AsylumCase asylumCase) {
        Fee fee;

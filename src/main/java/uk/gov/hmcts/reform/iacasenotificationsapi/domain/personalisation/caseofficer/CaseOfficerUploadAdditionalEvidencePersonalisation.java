...
public class CaseOfficerUploadAdditionalEvidencePersonalisation implements EmailNotificationPersonalisation {
    ...
    private final String caseOfficerUploadedAdditionalEvidenceTemplateId;
    private final PersonalisationProvider personalisationProvider;
    private final EmailAddressFinder emailAddressFinder;

    public CaseOfficerUploadAdditionalEvidencePersonalisation(
        @Value("${govnotify.template.uploadedAdditionalEvidence.caseOfficer.email}") String caseOfficerUploadedAdditionalEvidenceTemplateId,
        PersonalisationProvider personalisationProvider,
        EmailAddressFinder emailAddressFinder
    ) {
        this.caseOfficerUploadedAdditionalEvidenceTemplateId = caseOfficerUploadedAdditionalEvidenceTemplateId;
    ...
    public String getTemplateId() {
        return caseOfficerUploadedAdditionalEvidenceTemplateId;
    }

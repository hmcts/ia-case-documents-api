...
import static uk.gov.hmcts.reform.iacasenotificationsapi.domain.entities.DocumentTag.INTERNAL_DETAINED_APPEAL_SUBMITTED_OUT_OF_TIME_WITH_EXEMPTION_LETTER;
...
@Slf4j
@Service
public class DetentionEngagementTeamAppealSubmittedLateWithExemptionPersonalisation implements EmailWithLinkNotificationPersonalisation {
    ...
    public DetentionEngagementTeamAppealSubmittedLateWithExemptionPersonalisation(
    ...
    private JSONObject getAppealCanProceedLetterJsonObject(AsylumCase asylumCase) {
        try {
            return documentDownloadClient.getJsonObjectFromDocument(getLetterForNotification(asylumCase, INTERNAL_DETAINED_APPEAL_SUBMITTED_OUT_OF_TIME_WITH_EXEMPTION_LETTER));

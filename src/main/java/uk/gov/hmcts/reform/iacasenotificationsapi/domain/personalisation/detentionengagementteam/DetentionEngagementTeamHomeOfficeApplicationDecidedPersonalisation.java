...
import static uk.gov.hmcts.reform.iacasenotificationsapi.domain.entities.DocumentTag.HOME_OFFICE_APPLICATION_DECIDED_LETTER;
...
@Slf4j
@Service
public class DetentionEngagementTeamHomeOfficeApplicationDecidedPersonalisation implements EmailWithLinkNotificationPersonalisation {
    ...
    public DetentionEngagementTeamHomeOfficeApplicationDecidedPersonalisation(
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_HOME_OFFICE_APPLICATION_DECIDED";
    }
    ...
    private JSONObject getAppealCanProceedLetterJsonObject(AsylumCase asylumCase) {
        try {
            return documentDownloadClient.getJsonObjectFromDocument(getLetterForNotification(asylumCase, HOME_OFFICE_APPLICATION_DECIDED_LETTER));

...
@Service
public class AppellantTcwUploadAddendumEvidencePersonalisationSms implements SmsNotificationPersonalisation {
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_TCW_UPLOADED_ADDENDUM_EVIDENCE_AIP_APPELLANT_SMS";
    }

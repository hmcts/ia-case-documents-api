...
public class OpenIdUserDetailsProviderTest {

    private static final String BASE_URL = "http://base.url";
    private static final String USERINFO_URI = "/o/userinfo";

    @Mock private AccessTokenProvider accessTokenProvider;
    @Mock private RestTemplate restTemplate;

    private OpenIdUserDetailsProvider openIdUserDetailsProvider;

    @Before
    public void setUp() {

        openIdUserDetailsProvider =
            new OpenIdUserDetailsProvider(
                accessTokenProvider,
                restTemplate,
                BASE_URL,
                USERINFO_URI
    ...
    public void should_call_idam_api_to_get_user_details() {
        ...
        doReturn(new ResponseEntity<>(userDetails, HttpStatus.OK))
            .when(restTemplate)
            .exchange(
                eq(BASE_URL + USERINFO_URI),
                eq(HttpMethod.GET),
                any(HttpEntity.class),
                any(ParameterizedTypeReference.class)
            );

        UserDetails actualUserDetails = openIdUserDetailsProvider.getUserDetails();
    ...
    public void should_throw_exception_if_idam_id_missing() {
        ...
        assertThatThrownBy(() -> openIdUserDetailsProvider.getUserDetails())
            .hasMessage("OpenId user details missing 'uid' field")
    ...
    public void should_throw_exception_if_idam_roles_missing() {
        ...
        assertThatThrownBy(() -> openIdUserDetailsProvider.getUserDetails())
            .hasMessage("OpenId user details missing 'roles' field")
            .isExactlyInstanceOf(IllegalStateException.class);
    }
    ...
    public void should_throw_exception_if_idam_email_missing() {
        ...
        assertThatThrownBy(() -> openIdUserDetailsProvider.getUserDetails())
            .hasMessage("OpenId user details missing 'sub' field")
            .isExactlyInstanceOf(IllegalStateException.class);
    }
    ...
    public void should_throw_exception_if_idam_forename_missing() {
        ...
        assertThatThrownBy(() -> openIdUserDetailsProvider.getUserDetails())
            .hasMessage("OpenId user details missing 'given_name' field")
            .isExactlyInstanceOf(IllegalStateException.class);
    }
    ...
    public void should_throw_exception_if_idam_surname_missing() {
        ...
        assertThatThrownBy(() -> openIdUserDetailsProvider.getUserDetails())
            .hasMessage("OpenId user details missing 'family_name' field")
            .isExactlyInstanceOf(IllegalStateException.class);
    }

...
class RemoteCmrReListingLetterTemplateTest {
    ...
    private RemoteCmrReListingLetterTemplate remoteCmrReListingLetterTemplate;

    private final String templateName = "TB-IAC-LET-ENG-Remote-Edit-Case-Listing.docx";
    ...
    @BeforeEach
    void setUp() {
        remoteCmrReListingLetterTemplate =
                new RemoteCmrReListingLetterTemplate(
                        templateName,
    ...
    void should_return_template_name() {
        assertEquals(templateName, remoteCmrReListingLetterTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values_including_old_hearing_details() {
        ...
        Map<String, Object> templateFieldValues =
                remoteCmrReListingLetterTemplate.mapFieldValues(caseDetails, caseDetailsBefore);

...
class InternalUploadAdditionalEvidenceLetterTemplateTest {

    @Mock private CaseDetails<AsylumCase> caseDetails;
    @Mock private AsylumCase asylumCase;
    @Mock private CustomerServicesProvider customerServicesProvider;
    private InternalUploadAdditionalEvidenceLetterTemplate internalUploadAdditionalEvidenceLetterTemplate;
    private final String templateName = "TB-IAC-LET-ENG-00031.docx";
    ...
    void setUp() {
        internalUploadAdditionalEvidenceLetterTemplate =
            new InternalUploadAdditionalEvidenceLetterTemplate(
                templateName,
    ...
    void should_return_template_name() {
        ...
        assertEquals(templateName, internalUploadAdditionalEvidenceLetterTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values() {
        ...
        Map<String, Object> templateFieldValues = internalUploadAdditionalEvidenceLetterTemplate.mapFieldValues(caseDetails);

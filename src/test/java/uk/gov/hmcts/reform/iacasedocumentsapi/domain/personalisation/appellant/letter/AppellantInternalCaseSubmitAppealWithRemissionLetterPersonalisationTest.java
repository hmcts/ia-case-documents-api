...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.appellant.letter.AppellantInternalCaseSubmitAppealWithRemissionLetterPersonalisation;
...
class AppellantInternalCaseSubmitAppealWithRemissionLetterPersonalisationTest {
    ...
    public void setup() {
        ...
        appellantInternalCaseSubmitAppealWithRemissionLetterPersonalisation = new AppellantInternalCaseSubmitAppealWithRemissionLetterPersonalisation(
            letterTemplateId,
    ...
    void should_return_given_template_id() {
        assertEquals(letterTemplateId, appellantInternalCaseSubmitAppealWithRemissionLetterPersonalisation.getTemplateId());
    }

    @Test
    void should_return_given_reference_id() {
        assertEquals(ccdCaseId + "_INTERNAL_SUBMIT_APPEAL_WITH_REMISSION_APPELLANT_LETTER",
            appellantInternalCaseSubmitAppealWithRemissionLetterPersonalisation.getReferenceId(ccdCaseId));
    }
    ...
    void should_return_address_in_correct_format_appellant_out_of_country() {
        ...
        assertTrue(appellantInternalCaseSubmitAppealWithRemissionLetterPersonalisation.getRecipientsList(asylumCase).contains("50_Buildingname_Streetname_Townname_Spain"));
    }
    ...
    void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        assertThatThrownBy(
            () -> appellantInternalCaseSubmitAppealWithRemissionLetterPersonalisation.getPersonalisation((Callback<AsylumCase>) null))

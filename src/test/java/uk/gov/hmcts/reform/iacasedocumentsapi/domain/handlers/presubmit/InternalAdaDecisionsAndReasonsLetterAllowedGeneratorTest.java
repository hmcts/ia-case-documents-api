...
class InternalAdaDecisionsAndReasonsLetterAllowedGeneratorTest {
    ...
    private InternalAdaDecisionsAndReasonsLetterAllowedGenerator internalAdaDecisionsAndReasonsLetterAllowedGenerator;

    @BeforeEach
    public void setUp() {
        internalAdaDecisionsAndReasonsLetterAllowedGenerator =
            new InternalAdaDecisionsAndReasonsLetterAllowedGenerator(
    ...
    public void should_create_internal_ada_appeal_decided_allowed_pdf_and_append_to_notifications_documents() {
        ...
        PreSubmitCallbackResponse<AsylumCase> callbackResponse =
            internalAdaDecisionsAndReasonsLetterAllowedGenerator.handle(PreSubmitCallbackStage.ABOUT_TO_SUBMIT, callback);
    ...
    public void handling_should_throw_if_cannot_actually_handle() {
        ...
        assertThatThrownBy(() -> internalAdaDecisionsAndReasonsLetterAllowedGenerator.handle(PreSubmitCallbackStage.ABOUT_TO_START, callback))
            .hasMessage("Cannot handle callback")
            .isExactlyInstanceOf(IllegalStateException.class);

        when(callback.getEvent()).thenReturn(Event.START_APPEAL);
        assertThatThrownBy(() -> internalAdaDecisionsAndReasonsLetterAllowedGenerator.handle(PreSubmitCallbackStage.ABOUT_TO_SUBMIT, callback))
            .hasMessage("Cannot handle callback")
            .isExactlyInstanceOf(IllegalStateException.class);
    }
    ...
    public void it_cannot_handle_callback_if_is_admin_is_missing() {
        ...
        for (Event event : Event.values()) {
            ...
            for (PreSubmitCallbackStage callbackStage : PreSubmitCallbackStage.values()) {
                boolean canHandle = internalAdaDecisionsAndReasonsLetterAllowedGenerator.canHandle(callbackStage, callback);
    ...
    public void should_not_allow_null_arguments() {
        ...
        assertThatThrownBy(() -> internalAdaDecisionsAndReasonsLetterAllowedGenerator.canHandle(null, callback))
            .hasMessage("callbackStage must not be null")
            .isExactlyInstanceOf(NullPointerException.class);

        assertThatThrownBy(() -> internalAdaDecisionsAndReasonsLetterAllowedGenerator.canHandle(PreSubmitCallbackStage.ABOUT_TO_SUBMIT, null))
            .hasMessage("callback must not be null")
            .isExactlyInstanceOf(NullPointerException.class);

        assertThatThrownBy(() -> internalAdaDecisionsAndReasonsLetterAllowedGenerator.handle(null, callback))
            .hasMessage("callbackStage must not be null")
            .isExactlyInstanceOf(NullPointerException.class);

        assertThatThrownBy(() -> internalAdaDecisionsAndReasonsLetterAllowedGenerator.handle(PreSubmitCallbackStage.ABOUT_TO_SUBMIT, null))
            .hasMessage("callback must not be null")
            .isExactlyInstanceOf(NullPointerException.class);
    }

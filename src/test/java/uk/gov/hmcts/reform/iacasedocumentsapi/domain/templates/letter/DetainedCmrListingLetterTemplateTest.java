...
public class DetainedCmrListingLetterTemplateTest {
    ...
    private DetainedCmrListingLetterTemplate detainedCmrListingLetterTemplate;
    ...
    void setUp() {
        detainedCmrListingLetterTemplate =
            new DetainedCmrListingLetterTemplate(
                templateName,
    ...
    void should_return_template_name() {
        assertEquals(templateName, detainedCmrListingLetterTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values() {
        ...
        Map<String, Object> templateFieldValues = detainedCmrListingLetterTemplate.mapFieldValues(caseDetails);
    ...
    void should_map_old_hearing_channel_from_before_case_details() {
        ...
        Map<String, Object> templateFieldValues =
            detainedCmrListingLetterTemplate.mapFieldValues(caseDetails, caseDetailsBefore);
    ...
    void should_throw_when_cmr_hearing_centre_is_missing() {
        ...
        assertThrows(IllegalStateException.class,
            () -> detainedCmrListingLetterTemplate.mapFieldValues(caseDetails));
    }
}

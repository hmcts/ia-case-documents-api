...
public class PreSubmitBailCallbackControllerTest {
    ...
    private PreSubmitBailCallbackController preSubmitBailCallbackController;

    @BeforeEach
    public void setUp() {
        preSubmitBailCallbackController = new PreSubmitBailCallbackController(callbackDispatcher);
    }
    ...
    public void should_dispatch_about_to_start_callback_and_return_response() {
        ...
        ResponseEntity<PreSubmitCallbackResponse<BailCase>> actualResponse = preSubmitBailCallbackController.ccdAboutToStart(callback);
    ...
    public void should_dispatch_about_to_submit_callback_and_return_response() {
        ...
        ResponseEntity<PreSubmitCallbackResponse<BailCase>> actualResponse = preSubmitBailCallbackController.ccdAboutToSubmit(callback);

...
public class HomeOfficeNonStandardDirectionLetterTemplateTest {
    ...
    private HomeOfficeNonStandardDirectionLetterTemplate homeOfficeNonStandardDirectionLetterTemplate;
    ...
    private final String templateName = "TB-IAC-LET-ENG-00041.docx";
    ...
    public HomeOfficeNonStandardDirectionLetterTemplateTest() {
    }
    ...
    void should_return_template_name() {
        assertEquals(templateName, homeOfficeNonStandardDirectionLetterTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values() {
        ...
        Map<String, Object> templateFieldValues = homeOfficeNonStandardDirectionLetterTemplate.mapFieldValues(caseDetails);
        ...
        assertEquals(directionExplanation, templateFieldValues.get("directionExplanation"));

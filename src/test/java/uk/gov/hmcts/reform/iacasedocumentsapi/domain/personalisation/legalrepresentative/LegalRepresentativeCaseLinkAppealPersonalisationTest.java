...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.legalrepresentative.LegalRepresentativeCaseLinkAppealPersonalisation;
import uk.gov.hmcts.reform.iacasedocumentsapi.infrastructure.AppealService;
import uk.gov.hmcts.reform.iacasenotificationsapi.infrastructure.CustomerServicesProvider;

@ExtendWith(MockitoExtension.class)
class LegalRepresentativeCaseLinkAppealPersonalisationTest {
    ...
    private LegalRepresentativeCaseLinkAppealPersonalisation personalisation;

    @BeforeEach
    public void setUp() {
        personalisation = new LegalRepresentativeCaseLinkAppealPersonalisation(
    ...
    public void getReferenceId() {
        long caseId = 12345L;
        assertEquals(caseId + "_LEGAL_REPRESENTATIVE_CASE_LINK_APPEAL", personalisation.getReferenceId(caseId));
    }

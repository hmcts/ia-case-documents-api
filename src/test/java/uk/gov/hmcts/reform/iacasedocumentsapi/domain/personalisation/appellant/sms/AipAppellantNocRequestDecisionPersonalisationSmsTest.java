...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.appellant.sms.AipAppellantNocRequestDecisionPersonalisationSms;
...
class AipAppellantNocRequestDecisionPersonalisationSmsTest {
    ...
    void should_throw_exception_on_recipients_when_case_is_null() {
        ...
        assertThatThrownBy(() -> appellantNocRequestDecisionPersonalisationSms.getRecipientsList(null))

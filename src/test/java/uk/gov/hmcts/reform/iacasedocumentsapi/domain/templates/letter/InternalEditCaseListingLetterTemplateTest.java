...
public class InternalEditCaseListingLetterTemplateTest {
    ...
    public void should_map_case_data_to_template_field_values_in_country() {
        ...
        assertEquals(appellantGivenNames + " " + appellantFamilyName, templateFieldValues.get("address_line_1"));
        assertEquals(addressLine1, templateFieldValues.get("address_line_2"));
        assertEquals(addressLine2, templateFieldValues.get("address_line_3"));
        assertEquals(addressLine3, templateFieldValues.get("address_line_4"));
        assertEquals(postTown, templateFieldValues.get("address_line_5"));
        assertEquals(postCode, templateFieldValues.get("address_line_6"));
    ...
    public void should_map_case_data_to_template_field_values_ooc() {
        ...
        assertEquals(LocalDate.now().format(DateTimeFormatter.ofPattern("d MMMM yyyy")), templateFieldValues.get("dateLetterSent"));
        assertEquals(appellantGivenNames + " " + appellantFamilyName, templateFieldValues.get("address_line_1"));
        assertEquals(oocAddressLine1, templateFieldValues.get("address_line_2"));
        assertEquals(oocAddressLine2, templateFieldValues.get("address_line_3"));
        assertEquals(oocAddressLine3, templateFieldValues.get("address_line_4"));

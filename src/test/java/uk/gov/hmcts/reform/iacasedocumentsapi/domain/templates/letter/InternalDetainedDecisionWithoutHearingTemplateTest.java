...
public class InternalDetainedDecisionWithoutHearingTemplateTest {
    @Mock
    ...
    private final String templateName = "INTERNAL_DETAINED_DECISION_WITHOUT_HEARING_NOTICE_TEMPLATE.docx";
    private final String logo = "[userImage:hmcts.png]";
    private InternalDetainedDecisionWithoutHearingTemplate internalDetainedDecisionWithoutHearing;
    private Map<String, Object> fieldValuesMap;

    @BeforeEach
    public void setUp() {
        internalDetainedDecisionWithoutHearing =
                new InternalDetainedDecisionWithoutHearingTemplate(templateName, customerServicesProvider);
    }

    @Test
    void should_return_template_name() {
        assertEquals(templateName, internalDetainedDecisionWithoutHearing.getName());
    }
    ...
    void should_populate_template_correctly(String email, YesOrNo yesOrNo) {
        ...
        fieldValuesMap = internalDetainedDecisionWithoutHearing.mapFieldValues(caseDetails);

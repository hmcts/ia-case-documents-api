...
class InternalDetainedAppealSubmissionOutOfTimeWithExemptionTemplateTest {
    ...
    private InternalDetainedAppealSubmissionOutOfTimeWithExemptionTemplate template;

    @BeforeEach
    void setUp() {
        template = new InternalDetainedAppealSubmissionOutOfTimeWithExemptionTemplate(
            templateName,

...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.legalrepresentative.LegalRepresentativeRemissionDecisionPaRejectedPersonalisation;
import uk.gov.hmcts.reform.iacasenotificationsapi.infrastructure.CustomerServicesProvider;

@ExtendWith(MockitoExtension.class)
class LegalRepresentativeRemissionDecisionPaRejectedPersonalisationTest {
    ...
    private LegalRepresentativeRemissionDecisionPaRejectedPersonalisation
    ...
    void setUp() {
        ...
        legalRepresentativeRemissionDecisionRejectedPersonalisation =
            new LegalRepresentativeRemissionDecisionPaRejectedPersonalisation(

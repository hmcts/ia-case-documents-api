...
class InternalRefusalOfRemoval24wTimeframeApplicationLetterTemplateTest {
    ...
    private InternalRefusalOfRemoval24wTimeframeApplicationLetterTemplate internalRefusalOfRemoval24wTimeframeApplicationLetterTemplate;
    private Map<String, Object> fieldValuesMap;

    @BeforeEach
    public void setUp() {
        internalRefusalOfRemoval24wTimeframeApplicationLetterTemplate =
            new InternalRefusalOfRemoval24wTimeframeApplicationLetterTemplate(templateName, customerServicesProvider);
        dataSetup();
    }

    @Test
    void should_return_template_name() {
        assertEquals(templateName, internalRefusalOfRemoval24wTimeframeApplicationLetterTemplate.getName());
    }
    ...
    @Test
    void should_populate_template_correctly_with_appellant_occ_ho_application() {

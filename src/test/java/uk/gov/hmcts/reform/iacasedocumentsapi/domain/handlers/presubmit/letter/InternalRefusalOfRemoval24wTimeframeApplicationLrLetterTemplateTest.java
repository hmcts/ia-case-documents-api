...
class InternalRefusalOfRemoval24wTimeframeApplicationLrLetterTemplateTest {
    ...
    private String lrGivenNames = "Jane";
    private String lrFamilyName = "Doe";
    ...
    private InternalRefusalOfRemoval24wTimeframeApplicationLrLetterTemplate template;
    private Map<String, Object> fieldValuesMap;

    @BeforeEach
    public void setUp() {
        template =
            new InternalRefusalOfRemoval24wTimeframeApplicationLrLetterTemplate(templateName, customerServicesProvider);
        dataSetup();
    }
    ...
    void dataSetup() {
        ...
        when(asylumCase.read(LEGAL_REP_GIVEN_NAME, String.class)).thenReturn(Optional.of(lrGivenNames));
        when(asylumCase.read(LEGAL_REP_FAMILY_NAME_PAPER_J, String.class)).thenReturn(Optional.of(lrFamilyName));
    ...
    void should_populate_template_correctly() {
        ...
        assertEquals(lrGivenNames, fieldValuesMap.get("appellantGivenNames"));
        assertEquals(lrFamilyName, fieldValuesMap.get("appellantFamilyName"));

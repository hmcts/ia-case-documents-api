...
class BailEndApplicationTemplateHelperTest {
    ...
    private BailEndApplicationTemplateHelper bailEndApplicationTemplateHelper;
    private Map<String, Object> fieldValuesMap;

    @BeforeEach
    public void setUp() {
        bailEndApplicationTemplateHelper =
            new BailEndApplicationTemplateHelper(govCallChargesUrl, customerServicesProvider);
    }

    @Test
    void all_data_values_should_be_included_with_date_formatted() {
        dataSetUp();
        fieldValuesMap = bailEndApplicationTemplateHelper.getCommonMapFieldValues(caseDetails);

        checkCommonFields();
    }

    @Test
    void all_data_values_should_be_included_except_date_formatted() {
        dataSetUp();
        fieldValuesMap = bailEndApplicationTemplateHelper.getCommonMapFieldValues(caseDetails);

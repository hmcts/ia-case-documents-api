...
public class DetentionEngagementTeamDecisionWithoutHearingPersonalisationTest {
    ...
    public void setup() throws NotificationClientException, IOException {
        ...
        ReflectionTestUtils.setField(detentionEngagementTeamDecisionWithoutHearingPersonalisation, "adaSubjectPrefix", "ADA - SERVE IN PERSON");
        ReflectionTestUtils.setField(detentionEngagementTeamDecisionWithoutHearingPersonalisation, "nonAdaPrefix", "IAFT - SERVE IN PERSON");
        ...
        when(asylumCase.read(NOTIFICATION_ATTACHMENT_DOCUMENTS)).thenReturn(Optional.of(newArrayList(decisionWithoutHearingBundle)));
    ...
    @Test
    void should_return_given_detention_irc_email_address() {
        String detentionEngagementTeamEmail = "detention-irc@email.com";
        ...
        assertTrue(
                detentionEngagementTeamDecisionWithoutHearingPersonalisation.getRecipientsList(asylumCase).contains(detentionEngagementTeamEmail)
        );
    }

    @Test
    void should_return_given_detention_prison_email_address() {
        String detentionEngagementTeamEmail = "detention-prison@email.com";
        when(asylumCase.read(APPELLANT_IN_DETENTION, YesOrNo.class)).thenReturn(Optional.of(YesOrNo.YES));

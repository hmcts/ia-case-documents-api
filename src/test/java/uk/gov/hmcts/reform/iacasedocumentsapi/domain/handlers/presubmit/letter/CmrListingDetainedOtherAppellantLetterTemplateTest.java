...
class CmrListingDetainedOtherAppellantLetterTemplateTest {
    ...
    private CmrListingDetainedOtherAppellantLetterTemplate cmrListingDetainedOtherAppellantLetterTemplate;

    private final String templateName = "TB-IAC-LET-ENG-00007.docx";
    ...
    @BeforeEach
    void setUp() {
        cmrListingDetainedOtherAppellantLetterTemplate =
            new CmrListingDetainedOtherAppellantLetterTemplate(
                templateName,
    ...
    void should_return_template_name() {
        assertEquals(templateName, cmrListingDetainedOtherAppellantLetterTemplate.getName());
    }

...
public class AsylumPreSubmitCallbackDispatcherTest {
    ...
    public void should_sort_handlers_by_name() {
        ...
        PreSubmitCallbackHandler<AsylumCase> h3 = new HearingNoticeCreator(
                mock(DocumentCreator.class), mock(DocumentCreator.class), mock(DocumentCreator.class), mock(DocumentCreator.class),
                mock(DocumentHandler.class), mock(FeatureToggler.class), mock(DocumentReceiver.class),

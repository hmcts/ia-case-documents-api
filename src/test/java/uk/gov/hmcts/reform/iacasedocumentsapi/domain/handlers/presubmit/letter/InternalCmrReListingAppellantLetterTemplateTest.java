...
class InternalCmrReListingAppellantLetterTemplateTest {
    ...
    private InternalCmrReListingAppellantLetterTemplate internalCmrReListingAppellantLetterTemplate;
    ...
    @BeforeEach
    void setUp() {
        internalCmrReListingAppellantLetterTemplate =
            new InternalCmrReListingAppellantLetterTemplate(
                templateName,
    ...
    void should_return_template_name() {
        assertEquals(templateName, internalCmrReListingAppellantLetterTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values_including_old_hearing_details() {
        ...
        Map<String, Object> templateFieldValues =
            internalCmrReListingAppellantLetterTemplate.mapFieldValues(caseDetails, caseDetailsBefore);

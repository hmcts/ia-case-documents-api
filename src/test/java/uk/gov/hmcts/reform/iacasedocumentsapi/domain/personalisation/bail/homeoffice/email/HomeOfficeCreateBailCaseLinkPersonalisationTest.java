...
class HomeOfficeCreateBailCaseLinkPersonalisationTest {
    ...
    private HomeOfficeCreateBailCaseLinkPersonalisation homeOfficeCreateBailCaseLinkPersonalisation;
    ...
    public void setup() {
        ...
        homeOfficeCreateBailCaseLinkPersonalisation =
            new HomeOfficeCreateBailCaseLinkPersonalisation(templateIdWithLegalRep, templateIdWithoutLegalRep, homeOfficeEmailAddress);
    }

    @Test
    public void should_return_given_template_id() {
        assertEquals(templateIdWithLegalRep, homeOfficeCreateBailCaseLinkPersonalisation.getTemplateId(bailCase));
    }

    @Test
    public void should_return_given_reference_id() {
        assertEquals(caseId + "_CREATE_BAIL_CASE_LINK_HOME_OFFICE",
            homeOfficeCreateBailCaseLinkPersonalisation.getReferenceId(caseId));
    }
    ...
    public void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        assertThatThrownBy(
            () -> homeOfficeCreateBailCaseLinkPersonalisation.getPersonalisation((BailCase) null))
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation =
            homeOfficeCreateBailCaseLinkPersonalisation.getPersonalisation(bailCase);
    ...
    public void should_return_personalisation_when_no_LR_all_information_given() {
        ...
        assertEquals(templateIdWithoutLegalRep, homeOfficeCreateBailCaseLinkPersonalisation.getTemplateId(bailCase));
        assertEquals(bailReferenceNumber, personalisation.get("bailReferenceNumber"));
        assertEquals(applicantGivenNames, personalisation.get("applicantGivenNames"));
        assertEquals(applicantFamilyName, personalisation.get("applicantFamilyName"));
        assertEquals(homeOfficeReferenceNumber, personalisation.get("homeOfficeReferenceNumber"));

...
class RequestUserAccessTokenProviderTest {
    ...
    void try_get_access_from_http_request() {
        ...
        Assertions.assertTrue(optActualAccessToken.isPresent());
        Assertions.assertEquals(expectedAccessToken, optActualAccessToken.get());
    }
    ...
    void try_get_missing_access_token_from_http_request_returns_empty() {
        ...
        Assertions.assertFalse(optionalAccessToken.isPresent());
    }

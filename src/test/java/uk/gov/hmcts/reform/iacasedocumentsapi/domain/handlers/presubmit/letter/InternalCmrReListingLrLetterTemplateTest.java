...
class InternalCmrReListingLrLetterTemplateTest {
    ...
    private InternalCmrReListingLrLetterTemplate internalCmrReListingLrLetterTemplate;
    ...
    void setUp() {
        internalCmrReListingLrLetterTemplate =
            new InternalCmrReListingLrLetterTemplate(
                templateName,
    ...
    void should_return_template_name() {
        assertEquals(templateName, internalCmrReListingLrLetterTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values_including_old_hearing_details() {
        ...
        Map<String, Object> templateFieldValues =
            internalCmrReListingLrLetterTemplate.mapFieldValues(caseDetails, caseDetailsBefore);

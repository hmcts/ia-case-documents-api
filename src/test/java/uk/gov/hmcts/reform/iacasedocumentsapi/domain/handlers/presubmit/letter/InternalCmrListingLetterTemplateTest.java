...
class InternalCmrListingLetterTemplateTest {
    ...
    void should_return_template_name() {
        assertEquals(templateName, internalCmrListingLetterTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values() {
        ...
        Map<String, Object> templateFieldValues = internalCmrListingLetterTemplate.mapFieldValues(caseDetails);

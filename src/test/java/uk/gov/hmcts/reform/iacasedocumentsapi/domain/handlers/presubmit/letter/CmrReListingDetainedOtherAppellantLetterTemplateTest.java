...
class CmrReListingDetainedOtherAppellantLetterTemplateTest {
    ...
    private CmrReListingDetainedOtherAppellantLetterTemplate cmrReListingDetainedOtherAppellantLetterTemplate;
    ...
    @BeforeEach
    void setUp() {
        cmrReListingDetainedOtherAppellantLetterTemplate =
            new CmrReListingDetainedOtherAppellantLetterTemplate(
                templateName,
    ...
    void should_return_template_name() {
        assertEquals(templateName, cmrReListingDetainedOtherAppellantLetterTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values_including_old_hearing_details() {
        ...
        Map<String, Object> templateFieldValues =
            cmrReListingDetainedOtherAppellantLetterTemplate.mapFieldValues(caseDetails, caseDetailsBefore);

...
class InternalCmrListingAppellantLetterTemplateTest {
    ...
    private InternalCmrListingAppellantLetterTemplate internalCmrListingAppellantLetterTemplate;
    ...
    void setUp() {
        internalCmrListingAppellantLetterTemplate =
            new InternalCmrListingAppellantLetterTemplate(
                templateName,
    ...
    void should_return_template_name() {
        assertEquals(templateName, internalCmrListingAppellantLetterTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values() {
        ...
        Map<String, Object> templateFieldValues = internalCmrListingAppellantLetterTemplate.mapFieldValues(caseDetails);
    ...
    void should_throw_when_cmr_hearing_centre_is_missing() {
        ...
        assertThrows(IllegalStateException.class,
            () -> internalCmrListingAppellantLetterTemplate.mapFieldValues(caseDetails));
    }
}
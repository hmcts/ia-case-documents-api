...
class InternalDetainedAppealSubmissionWithExemptionTemplateTest {
    ...
    private InternalDetainedAppealSubmissionWithExemptionTemplate template;

    @BeforeEach
    void setUp() {
        template = new InternalDetainedAppealSubmissionWithExemptionTemplate(
            templateName,

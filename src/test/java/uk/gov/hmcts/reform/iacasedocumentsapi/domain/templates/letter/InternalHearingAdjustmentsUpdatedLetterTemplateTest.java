...
public class InternalHearingAdjustmentsUpdatedLetterTemplateTest {

    @Mock private CaseDetails<AsylumCase> caseDetails;
    @Mock private AsylumCase asylumCase;
    @Mock private CustomerServicesProvider customerServicesProvider;
    @Mock private DateProvider dateProvider;
    private InternalHearingAdjustmentsUpdatedLetterTemplate internalHearingAdjustmentsUpdatedLetterTemplate;
    private final String templateName = "TB-IAC-LET-ENG-00030.docx";
    ...
    void setUp() {
        internalHearingAdjustmentsUpdatedLetterTemplate =
            new InternalHearingAdjustmentsUpdatedLetterTemplate(
                templateName,
                dateProvider,
    ...
    void should_return_template_name() {
        ...
        assertEquals(templateName, internalHearingAdjustmentsUpdatedLetterTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values() {
        ...
        Map<String, Object> templateFieldValues = internalHearingAdjustmentsUpdatedLetterTemplate.mapFieldValues(caseDetails);

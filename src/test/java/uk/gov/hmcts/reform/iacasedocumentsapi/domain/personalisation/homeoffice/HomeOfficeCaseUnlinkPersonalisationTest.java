...
class HomeOfficeCaseUnlinkPersonalisationTest {
    ...
    private HomeOfficeCaseUnlinkPersonalisation personalisation;

    @BeforeEach
    public void setUp() {
        personalisation = new HomeOfficeCaseUnlinkPersonalisation(
    ...
    public void getReferenceId() {
        long caseId = 12345L;
        assertEquals(caseId + "_CASE_UNLINK_APPEAL_HOME_OFFICE", personalisation.getReferenceId(caseId));
    }

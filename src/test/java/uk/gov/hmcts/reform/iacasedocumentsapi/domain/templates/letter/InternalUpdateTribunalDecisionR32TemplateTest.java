...
class InternalUpdateTribunalDecisionR32TemplateTest {

    @Mock private CaseDetails<AsylumCase> caseDetails;
    @Mock private AsylumCase asylumCase;
    @Mock private CustomerServicesProvider customerServicesProvider;
    private InternalUpdateTribunalDecisionR32Template internalUpdateTribunalDecisionR32Template;
    ...
    @BeforeEach
    void setUp() {
        internalUpdateTribunalDecisionR32Template =
            new InternalUpdateTribunalDecisionR32Template(
                templateName,
    ...
    void should_return_template_name() {
        ...
        assertEquals(templateName, internalUpdateTribunalDecisionR32Template.getName());
    }
    ...
    void should_map_case_data_to_template_field_values() {
        ...
        Map<String, Object> templateFieldValues = internalUpdateTribunalDecisionR32Template.mapFieldValues(caseDetails);

...
class InternalDetainedAppealHoUploadBundleAppellantLetterGeneratorTest {
    ...
    private InternalDetainedAppealHoUploadBundleAppellantLetterGenerator generator;

    @BeforeEach
    void setUp() {
        generator = new InternalDetainedAppealHoUploadBundleAppellantLetterGenerator(documentCreator, documentHandler);

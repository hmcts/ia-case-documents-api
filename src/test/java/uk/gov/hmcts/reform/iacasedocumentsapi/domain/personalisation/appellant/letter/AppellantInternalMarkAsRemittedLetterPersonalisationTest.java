...
import uk.gov.hmcts.reform.iacasedocumentsapi.domain.personalisation.appellant.letter.AppellantInternalMarkAsRemittedLetterPersonalisation;
...
class AppellantInternalMarkAsRemittedLetterPersonalisationTest {
    ...
    void should_return_legalRep_address_in_correct_format() {
        ...
        assertTrue(appellantInternalMarkAsRemittedLetterPersonalisation.getRecipientsList(asylumCase).contains("CalleToledo32_Madrid_28003_Townname_Spain"));
    }

...
class InternalDetainedPrisonIrcAppealSubmissionTemplateTest {
    ...
    private InternalDetainedPrisonIrcAppealSubmissionTemplate internalDetainedPrisonIrcAppealSubmissionTemplate;
    ...
    @BeforeEach
    void setUp() {
        internalDetainedPrisonIrcAppealSubmissionTemplate =
                new InternalDetainedPrisonIrcAppealSubmissionTemplate(
                        templateName,
    ...
    void should_return_template_name() {
        assertEquals(templateName, internalDetainedPrisonIrcAppealSubmissionTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values() {
        ...
        Map<String, Object> templateFieldValues = internalDetainedPrisonIrcAppealSubmissionTemplate.mapFieldValues(caseDetails);
        ...
        assertEquals(formatDateForNotificationAttachmentDocument(LocalDate.parse(appealSubmissionDate).plusDays(10)), templateFieldValues.get("tenDaysAfterSubmitDate"));
    }
    ...
    void should_throw_when_appeal_submission_date_is_not_present() {
        ...
        assertThatThrownBy(() -> internalDetainedPrisonIrcAppealSubmissionTemplate.mapFieldValues(caseDetails))

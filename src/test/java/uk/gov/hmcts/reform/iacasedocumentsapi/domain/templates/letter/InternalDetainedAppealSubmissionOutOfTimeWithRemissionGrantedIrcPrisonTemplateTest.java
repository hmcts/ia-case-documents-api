...
class InternalDetainedAppealSubmissionOutOfTimeWithRemissionGrantedIrcPrisonTemplateTest {
    ...
    private final String templateName = "TB-IAC-DEC-ENG-00018.docx";
    ...
    private final String dueDate = "15 Aug 2023";
    ...
    private InternalDetainedAppealSubmissionOutOfTimeWithRemissionGrantedIrcPrisonTemplate template;

    @BeforeEach
    void setUp() {
        template = new InternalDetainedAppealSubmissionOutOfTimeWithRemissionGrantedIrcPrisonTemplate(
                templateName,
    ...
    void should_map_case_data_to_template_field_values() {
        ...
        assertEquals(dueDate, templateFieldValues.get("daysAfterSubmissionDate"));
    ...
    void should_handle_missing_optional_fields() {
        ...
        when(systemDateProvider.dueDate(daysAfterSubmitAppeal)).thenReturn(dueDate);
    ...
    void should_handle_blank_reference_numbers() {
        ...
        assertEquals("", templateFieldValues.get("appealReferenceNumber"));
        assertEquals("", templateFieldValues.get("homeOfficeReferenceNumber"));
        assertEquals(Optional.of(""), templateFieldValues.get("onlineCaseRefNumber"));
    }

...
class InternalHoFtpaDecidedGrantedLetterTemplateTest {
    ...
    private final String templateName = "INTERNAL_HO_FTPA_DECIDED_GRANTED_NOTICE_TEMPLATE.docx";
    private final String logo = "[userImage:hmcts.png]";
    private InternalHoFtpaDecidedGrantedLetterTemplate internalHoFtpaDecidedGrantedLetterTemplate;
    private Map<String, Object> fieldValuesMap;

    @BeforeEach
    public void setUp() {
        internalHoFtpaDecidedGrantedLetterTemplate =
                new InternalHoFtpaDecidedGrantedLetterTemplate(templateName, customerServicesProvider);
    }

    @Test
    void should_return_template_name() {
        assertEquals(templateName, internalHoFtpaDecidedGrantedLetterTemplate.getName());
    }
    ...
    void should_populate_template() {
        dataSetup();
        fieldValuesMap = internalHoFtpaDecidedGrantedLetterTemplate.mapFieldValues(caseDetails);

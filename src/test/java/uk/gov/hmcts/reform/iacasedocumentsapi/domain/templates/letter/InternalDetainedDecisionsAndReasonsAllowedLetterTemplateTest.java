...
public class InternalDetainedDecisionsAndReasonsAllowedLetterTemplateTest {

    @Mock
    private CaseDetails<AsylumCase> caseDetails;
    @Mock
    private AsylumCase asylumCase;
    private final String templateName = "Internal_Detained_Decisions_And_Reasons_Allowed.docx";
    @Mock private DueDateService dueDateService;
    @Mock private CustomerServicesProvider customerServicesProvider;

    private InternalDetainedDecisionsAndReasonsAllowedLetterTemplate internalDetainedDecisionsAndReasonsAllowedLetterTemplate;
    ...
    private static final int FTPA_DUE_IN_WORKING_DAYS = 7;
    private static final int FTPA_DUE_CALENDAR_DAYS = 14;


    @BeforeEach
    void setUp() {
        internalDetainedDecisionsAndReasonsAllowedLetterTemplate =
                new InternalDetainedDecisionsAndReasonsAllowedLetterTemplate(
                        templateName,
                        customerServicesProvider,
                        dueDateService,
                        FTPA_DUE_IN_WORKING_DAYS,
    ...
    void should_return_template_name() {
        ...
        assertEquals(templateName, internalDetainedDecisionsAndReasonsAllowedLetterTemplate.getName());
    }

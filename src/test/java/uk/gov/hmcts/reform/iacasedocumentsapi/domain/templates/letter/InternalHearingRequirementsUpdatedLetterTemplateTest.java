...
public class InternalHearingRequirementsUpdatedLetterTemplateTest {

    @Mock private CaseDetails<AsylumCase> caseDetails;
    @Mock private AsylumCase asylumCase;
    @Mock private CustomerServicesProvider customerServicesProvider;
    @Mock private DateProvider dateProvider;
    private InternalHearingRequirementsUpdatedLetterTemplate internalHearingRequirementsUpdatedLetterTemplate;
    ...
    @BeforeEach
    void setUp() {
        internalHearingRequirementsUpdatedLetterTemplate =
            new InternalHearingRequirementsUpdatedLetterTemplate(
                templateName,
                dateProvider,
    ...
    void should_return_template_name() {
        ...
        assertEquals(templateName, internalHearingRequirementsUpdatedLetterTemplate.getName());
    }

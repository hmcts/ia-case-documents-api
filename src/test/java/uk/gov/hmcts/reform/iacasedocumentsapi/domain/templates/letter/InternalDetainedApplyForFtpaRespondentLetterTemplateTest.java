...
class InternalDetainedApplyForFtpaRespondentLetterTemplateTest {
    @Mock
    ...
    private InternalDetainedApplyForFtpaRespondentLetterTemplate internalDetainedApplyForFtpaRespondentLetterTemplate;
    private final String templateName = "TB-IAC-LET-ENG-00009.docx";
    ...
    void setUp() {
        internalDetainedApplyForFtpaRespondentLetterTemplate =
                new InternalDetainedApplyForFtpaRespondentLetterTemplate(
                        templateName,
    ...
    void should_return_template_name() {
        assertEquals(templateName, internalDetainedApplyForFtpaRespondentLetterTemplate.getName());
    }
    ...
    void should_map_case_data_to_template_field_values() {
        ...
        Map<String, Object> templateFieldValues = internalDetainedApplyForFtpaRespondentLetterTemplate.mapFieldValues(caseDetails);

...
public class HearingDetailsFinderTest {
    ...
    public void should_return_hearing_centre_name_for_decision_without_hearing_appeal() {
        ...
        assertEquals(HearingDetailsFinder.DECISION_WITHOUT_HEARING, hearingDetailsFinder.getHearingCentreName(asylumCase));
    }
    ...
    void should_throw_exception_when_hearing_centre_is_empty() {
        when(asylumCase.read(AsylumCaseDefinition.LIST_CASE_HEARING_CENTRE, HearingCentre.class)).thenReturn(Optional.empty());
    ...
    void should_throw_exception_when_hearing_centre_is_empty_in_remote_hearing() {
        when(asylumCase.read(AsylumCaseDefinition.LIST_CASE_HEARING_CENTRE, HearingCentre.class)).thenReturn(Optional.of(HearingCentre.REMOTE_HEARING));

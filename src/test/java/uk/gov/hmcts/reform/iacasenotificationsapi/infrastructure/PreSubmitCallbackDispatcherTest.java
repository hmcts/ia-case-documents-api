...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.handlers.presubmit.*;
...
public class PreSubmitCallbackDispatcherTest {
    ...
    public void should_sort_handlers_by_name() {
        PreSubmitCallbackHandler<AsylumCase> h1 = new BuildCaseDirectionNotifier(
            "mock", mock(LegalRepresentativePersonalisationFactory.class), mock(DirectionFinder.class), mock(NotificationSender.class), mock(NotificationIdAppender.class)
        );

        PreSubmitCallbackHandler<AsylumCase> h2 = new LegalRepresentativeHearingRequirementsDirectionNotifier(
            "mock", mock(LegalRepresentativePersonalisationFactory.class), mock(DirectionFinder.class), mock(NotificationSender.class), mock(NotificationIdAppender.class)
        );

        PreSubmitCallbackHandler<AsylumCase> h3 = new LegalRepresentativeReviewDirectionNotifier(
            "mock", mock(LegalRepresentativePersonalisationFactory.class), mock(DirectionFinder.class), mock(NotificationSender.class), mock(NotificationIdAppender.class)
        );

        PreSubmitCallbackHandler<AsylumCase> h4 = new RespondentEvidenceDirectionNotifier(
            "mock", "mock", mock(RespondentDirectionPersonalisationFactory.class), mock(DirectionFinder.class), mock(NotificationSender.class), mock(NotificationIdAppender.class)
        );

        PreSubmitCallbackHandler<AsylumCase> h5 = new RespondentNonStandardDirectionNotifier(
            "mock", "mock", mock(RespondentDirectionPersonalisationFactory.class), mock(DirectionFinder.class), mock(NotificationSender.class), mock(NotificationIdAppender.class)
        );

        PreSubmitCallbackHandler<AsylumCase> h6 = new RespondentReviewDirectionNotifier(
            "mock", "mock", mock(RespondentDirectionPersonalisationFactory.class), mock(DirectionFinder.class), mock(NotificationSender.class), mock(NotificationIdAppender.class)
        );

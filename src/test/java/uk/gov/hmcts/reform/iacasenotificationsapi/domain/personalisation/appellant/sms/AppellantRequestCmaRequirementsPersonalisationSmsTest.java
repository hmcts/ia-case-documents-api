...
public class AppellantRequestCmaRequirementsPersonalisationSmsTest {
    ...
    public void should_return_given_reference_id() {
        assertEquals(caseId + "_REQUEST_CMA_REQUIREMENTS_APPELLANT_AIP_SMS", appellantRequestCmaRequirementsPersonalisationSms.getReferenceId(caseId));
    }
    ...
    public void should_return_given_mobile_mobile_list_from_subscribers_in_asylum_case() {
        ...
        assertTrue(appellantRequestCmaRequirementsPersonalisationSms.getRecipientsList(asylumCase).contains(mockedAppellantMobilePhone));
    }

    @Test
    public void should_throw_exception_on_personalisation_when_case_is_null() {

        assertThatThrownBy(() -> appellantRequestCmaRequirementsPersonalisationSms.getPersonalisation((AsylumCase) null))
            .isExactlyInstanceOf(NullPointerException.class)
            .hasMessage("asylumCase must not be null");
    }
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation = appellantRequestCmaRequirementsPersonalisationSms.getPersonalisation(asylumCase);

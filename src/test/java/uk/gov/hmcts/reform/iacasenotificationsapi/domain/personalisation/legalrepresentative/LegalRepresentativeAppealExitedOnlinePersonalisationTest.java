...
public class LegalRepresentativeAppealExitedOnlinePersonalisationTest {
    ...
    public void should_return_given_email_address() {
        assertTrue(legalRepresentativeAppealExitedOnlinePersonalisation.getRecipientsList(asylumCase).contains(emailAddress));
    }

    @Test
    public void should_throw_exception_on_personalisation_when_case_is_null() {

        assertThatThrownBy(() -> legalRepresentativeAppealExitedOnlinePersonalisation.getPersonalisation((AsylumCase) null))
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation = legalRepresentativeAppealExitedOnlinePersonalisation.getPersonalisation(asylumCase);

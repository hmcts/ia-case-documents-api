...
public class LegalRepresentativeAddAppealPersonalisationTest {
    ...
    public void should_return_given_reference_id() {
        assertEquals(caseId + "_LEGAL_REPRESENTATIVE_REVIEW_DIRECTION", legalRepresentativeAddAppealPersonalisation.getReferenceId(caseId));
    }

    @Test
    public void should_return_given_email_address_from_asylum_case() {
        assertEquals(legalRepEmailAddress, legalRepresentativeAddAppealPersonalisation.getEmailAddress(asylumCase));
    }
    ...
    public void should_throw_exception_when_cannot_find_email_address_for_legal_rep() {
        ...
        assertThatThrownBy(() -> legalRepresentativeAddAppealPersonalisation.getEmailAddress(asylumCase))

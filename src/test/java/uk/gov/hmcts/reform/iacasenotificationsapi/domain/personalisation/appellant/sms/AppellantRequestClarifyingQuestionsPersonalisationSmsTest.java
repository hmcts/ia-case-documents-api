...
public class AppellantRequestClarifyingQuestionsPersonalisationSmsTest {
    ...
    private AppellantRequestClarifyingQuestionsPersonalisationSms appellantRequestClarifyingQuestionsSubmissionPersonalisationSms;
    ...
    public void setup() {
        ...
        appellantRequestClarifyingQuestionsSubmissionPersonalisationSms = new AppellantRequestClarifyingQuestionsPersonalisationSms(
            smsTemplateId,
            iaAipFrontendUrl,
            recipientsFinder,
            directionFinder);
    ...
    public void should_return_given_reference_id() {
        assertEquals(caseId + "_REQUEST_CLARIFYING_QUESTIONS_APPELLANT_AIP_SMS", appellantRequestClarifyingQuestionsSubmissionPersonalisationSms.getReferenceId(caseId));
    }
    ...
    public void should_throw_exception_on_recipients_when_case_is_null() {
        ...
        assertThatThrownBy(() -> appellantRequestClarifyingQuestionsSubmissionPersonalisationSms.getRecipientsList(null))
    ...
    public void should_throw_exception_on_personalisation_when_direction_is_empty() {
        ...
        assertThatThrownBy(() -> appellantRequestClarifyingQuestionsSubmissionPersonalisationSms.getPersonalisation(asylumCase))
    ...
    public void should_return_given_mobile_mobile_list_from_subscribers_in_asylum_case() {
        ...
        assertTrue(appellantRequestClarifyingQuestionsSubmissionPersonalisationSms.getRecipientsList(asylumCase).contains(mockedAppellantMobilePhone));
    }

    @Test
    public void should_throw_exception_on_personalisation_when_case_is_null() {

        assertThatThrownBy(() -> appellantRequestClarifyingQuestionsSubmissionPersonalisationSms.getPersonalisation((AsylumCase) null))
            .isExactlyInstanceOf(NullPointerException.class)
            .hasMessage("asylumCase must not be null");
    }
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation = appellantRequestClarifyingQuestionsSubmissionPersonalisationSms.getPersonalisation(asylumCase);

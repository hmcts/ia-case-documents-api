...
public class RespondentEvidenceDirectionNotifierTest {
    ...
    final String respondentEvidenceDirectionExplanation = "Send your evidence";
    final String respondentEvidenceDirectionDateDue = "2018-12-31";
    final String respondentEvidenceDirectionDateDueFormatted = "31 Dec 2018";
    ...
    final Map<String, String> expectedPersonalisation =
        ImmutableMap
            ...
            .put("Explanation", respondentEvidenceDirectionExplanation)

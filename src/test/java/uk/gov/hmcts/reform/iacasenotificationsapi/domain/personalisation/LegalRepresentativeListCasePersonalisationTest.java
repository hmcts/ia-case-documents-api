...
public class LegalRepresentativeListCasePersonalisationTest {
    ...
    public void should_return_given_email_address_from_asylum_case() {
        assertEquals(legalRepEmailAddress, legalRepresentativeListCasePersonalisation.getEmailAddress(asylumCase));
    }
    ...
    public void should_throw_exception_when_cannot_find_email_address_for_legal_rep() {
        ...
        assertThatThrownBy(() -> legalRepresentativeListCasePersonalisation.getEmailAddress(asylumCase))

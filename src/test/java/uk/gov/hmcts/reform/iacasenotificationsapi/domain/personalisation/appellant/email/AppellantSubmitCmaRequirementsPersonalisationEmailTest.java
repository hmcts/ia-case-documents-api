...
public class AppellantSubmitCmaRequirementsPersonalisationEmailTest {
    ...
    public void should_return_given_reference_id() {
        assertEquals(caseId + "_SUBMIT_CMA_REQUIREMENTS_APPELLANT_AIP_EMAIL", appellantCmaRequirementsSubmittedPersonalisationEmail.getReferenceId(caseId));
    }
    ...
    public void should_return_given_email_address_list_from_subscribers_in_asylum_case() {
        ...
        assertTrue(appellantCmaRequirementsSubmittedPersonalisationEmail.getRecipientsList(asylumCase).contains(mockedAppellantEmailAddress));
    }
    ...
    public void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        assertThatThrownBy(() -> appellantCmaRequirementsSubmittedPersonalisationEmail.getRecipientsList(null))
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation = appellantCmaRequirementsSubmittedPersonalisationEmail.getPersonalisation(asylumCase);

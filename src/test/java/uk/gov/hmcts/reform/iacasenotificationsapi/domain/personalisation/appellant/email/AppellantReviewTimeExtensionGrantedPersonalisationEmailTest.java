...
public class AppellantReviewTimeExtensionGrantedPersonalisationEmailTest {
    ...
    private AppellantReviewTimeExtensionGrantedPersonalisationEmail appellantReviewTimeExtensionGrantedPersonalisationEmail;
    ...
    public void setup() {
        ...
        appellantReviewTimeExtensionGrantedPersonalisationEmail = new AppellantReviewTimeExtensionGrantedPersonalisationEmail(
            smsTemplateId,
            iaAipFrontendUrl,
            recipientsFinder,
            timeExtensionFinder
    ...
    public void should_return_given_reference_id() {
        Assert.assertEquals(caseId + "_REVIEW_TIME_EXTENSION_GRANTED_APPELLANT_AIP_EMAIL", appellantReviewTimeExtensionGrantedPersonalisationEmail.getReferenceId(caseId));
    }
    ...
    public void should_return_given_mobile_mobile_list_from_subscribers_in_asylum_case() {
        ...
        assertTrue(appellantReviewTimeExtensionGrantedPersonalisationEmail.getRecipientsList(asylumCase).contains(mockedAppellantEmailAddress));
    }

    @Test
    public void should_throw_exception_on_personalisation_when_case_is_null() {

        assertThatThrownBy(() -> appellantReviewTimeExtensionGrantedPersonalisationEmail.getPersonalisation((Callback<AsylumCase>) null))
            .isExactlyInstanceOf(NullPointerException.class)
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation = appellantReviewTimeExtensionGrantedPersonalisationEmail.getPersonalisation(callback);

...
public class LegalRepresentativeChangeHearingCentrePersonalisationTest {
    ...
    public void setup() {
        ...
        legalRepresentativeChangeHearingCentrePersonalisation =
            new LegalRepresentativeChangeHearingCentrePersonalisation(templateId);
    }
    ...
    public void should_return_given_reference_id() {
        Long caseId = 12345L;
        assertEquals(caseId + "_CHANGE_HEARING_CENTRE_LEGAL_REPRESENTATIVE",
            legalRepresentativeChangeHearingCentrePersonalisation.getReferenceId(caseId));
    }

    @Test
    public void should_return_given_email_address_from_asylum_case() {
        assertTrue(legalRepresentativeChangeHearingCentrePersonalisation.getRecipientsList(asylumCase)
    ...
    public void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        assertThatThrownBy(
            () -> legalRepresentativeChangeHearingCentrePersonalisation.getPersonalisation((AsylumCase) null))
    ...
    public void should_return_personalisation_when_all_information_given(YesOrNo isAda) {
        ...
        initializePrefixes(legalRepresentativeChangeHearingCentrePersonalisation);
        Map<String, String> personalisation =
            legalRepresentativeChangeHearingCentrePersonalisation.getPersonalisation(asylumCase);

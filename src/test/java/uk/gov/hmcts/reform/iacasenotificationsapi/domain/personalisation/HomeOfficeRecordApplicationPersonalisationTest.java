...
public class HomeOfficeRecordApplicationPersonalisationTest {
    ...
    public void should_return_given_email_address_from_lookup_map() {
        assertEquals(homeOfficeEmailAddress, homeOfficeRecordApplicationPersonalisation.getEmailAddress(asylumCase));
    }
    ...
    public void should_return_default_email_address_when_home_office_is_empty() {
        ...
        assertEquals(defaultHomeOfficeEmailAddress, homeOfficeRecordApplicationPersonalisation.getEmailAddress(asylumCase));
    }

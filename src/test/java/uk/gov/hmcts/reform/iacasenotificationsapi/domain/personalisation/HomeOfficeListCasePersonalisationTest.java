...
public class HomeOfficeListCasePersonalisationTest {
    ...
    public void should_return_given_email_address_from_lookup_map() {
        assertEquals(homeOfficeEmailAddress, homeOfficeListCasePersonalisation.getEmailAddress(asylumCase));
    }
    ...
    public void should_throw_exception_on_email_address_when_home_office_is_empty() {
        ...
        assertThatThrownBy(() -> homeOfficeListCasePersonalisation.getEmailAddress(asylumCase))

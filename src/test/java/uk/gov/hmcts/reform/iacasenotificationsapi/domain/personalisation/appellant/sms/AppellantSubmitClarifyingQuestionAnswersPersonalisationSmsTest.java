...
public class AppellantSubmitClarifyingQuestionAnswersPersonalisationSmsTest {
    ...
    public void should_return_given_template_id() {
        Assert.assertEquals(smsTemplateId, appellantClarifyingQuestionsAnswersSubmittedPersonalisationSms.getTemplateId());
    }

    @Test
    public void should_return_given_reference_id() {
        Assert.assertEquals(caseId + "_SUBMIT_CLARIFYING_QUESTION_ANSWERS_APPELLANT_AIP_SMS", appellantClarifyingQuestionsAnswersSubmittedPersonalisationSms.getReferenceId(caseId));
    }
    ...
    public void should_return_given_mobile_mobile_list_from_subscribers_in_asylum_case() {
        ...
        assertTrue(appellantClarifyingQuestionsAnswersSubmittedPersonalisationSms.getRecipientsList(asylumCase).contains(mockedAppellantMobilePhone));
    }

    @Test
    public void should_throw_exception_on_personalisation_when_case_is_null() {

        assertThatThrownBy(() -> appellantClarifyingQuestionsAnswersSubmittedPersonalisationSms.getPersonalisation((AsylumCase) null))
            .isExactlyInstanceOf(NullPointerException.class)
            .hasMessage("asylumCase must not be null");
    }
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation = appellantClarifyingQuestionsAnswersSubmittedPersonalisationSms.getPersonalisation(asylumCase);

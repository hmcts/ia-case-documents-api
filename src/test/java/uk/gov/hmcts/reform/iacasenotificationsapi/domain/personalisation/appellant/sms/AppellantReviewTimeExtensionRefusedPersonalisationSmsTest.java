...
public class AppellantReviewTimeExtensionRefusedPersonalisationSmsTest {
    ...
    public void setup() {
        ...
        appellantReviewTimeExtensionRefusedPersonalisationSms = new AppellantReviewTimeExtensionRefusedPersonalisationSms(
            smsTemplateId,
            iaAipFrontendUrl,
            recipientsFinder,
            timeExtensionFinder
    ...
    public void should_return_given_reference_id() {
        Assert.assertEquals(caseId + "_REVIEW_TIME_EXTENSION_REFUSED_APPELLANT_AIP_SMS", appellantReviewTimeExtensionRefusedPersonalisationSms.getReferenceId(caseId));
    }
    ...
    public void should_return_given_mobile_mobile_list_from_subscribers_in_asylum_case() {
        ...
        assertTrue(appellantReviewTimeExtensionRefusedPersonalisationSms.getRecipientsList(asylumCase).contains(mockedAppellantMobilePhone));
    }

    @Test
    public void should_throw_exception_on_personalisation_when_case_is_null() {

        assertThatThrownBy(() -> appellantReviewTimeExtensionRefusedPersonalisationSms.getPersonalisation((Callback<AsylumCase>) null))
            .isExactlyInstanceOf(NullPointerException.class)
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation = appellantReviewTimeExtensionRefusedPersonalisationSms.getPersonalisation(callback);
